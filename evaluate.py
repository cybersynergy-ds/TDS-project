...
from datagen import get_comments,get_contacts,get_credit_card,get_dates,get_docs,get_email,get_logs,get_markdown,get_tickets
...
def num(input_string):
    return int(hashlib.sha256(input_string.encode()).hexdigest(), 16) % (2**32)
...
async def main():
    email = "24f1001586@ds.study.iitm.ac.in"  # Set the email as requested
    score, total = 0, 0
